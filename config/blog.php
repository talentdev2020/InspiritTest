...
return [
    ...
    'admin_email' => env('ADMIN_EMAIL') ?: 'admin@tommy.com',
    ...
    // Meta
    'meta' => [
        'keywords' => 'Test,blog,tommy,laravel,vuejs',
        'description' => 'Nothing is impossible in Test'
    ],
    ...
    'footer' => [
        ...
        'twitter' => [
            'open' => true,
            'url'  => 'https://twitter.com/tommy'
        ],
        'meta' => '© Test 2016. Powered By Jiajian Chan',
    ],
